...
export function RacingDashboard() {
  ...
  const handleAddTracker = () => {
    if (trackerInput && !options.trackerFilter?.includes(trackerInput)) {
      setOptions(prev => ({
        ...prev,
        trackerFilter: [...(prev.trackerFilter || []), trackerInput],
      }))
      setTrackerInput("")
    }
  }
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              <Input
                ...
                onKeyPress={(e) => e.key === "Enter" && handleAddTracker()}
              />
              <Button onClick={handleAddTracker} size="sm">Add</Button>
            </div>
