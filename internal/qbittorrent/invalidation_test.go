...
// TestCacheInvalidation_MultipleInstances tests cache invalidation across multiple instances
func TestCacheInvalidation_MultipleInstances(t *testing.T) {
	// Skip since caching was removed
	t.Skip("Caching has been removed from the sync manager")
}

// TestCacheInvalidation_CacheKeyPatterns tests the cache key patterns used for invalidation
